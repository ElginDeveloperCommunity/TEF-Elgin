...
'Declaraï¿½ï¿½es de variï¿½veis para a impressora
Public tipo As Long
...
Private Sub Imprime(ByVal dados As String)
    If AbreConexaoImpressora(tipo, modelo, conexao, parametro) = 0 Then
        ...
        FechaConexaoImpressora
    Else
        MsgBox "hï¿½ algum problema com a conexï¿½o com a impressora"
    End If
End Sub
...
Private Sub reImpressaoButton_Click()
    If TestaConexao <> "" Then
        ...
        End If
    Else
        MsgBox "Nï¿½o ï¿½ possï¿½vel imprimir seu comprovante pois nenhuma impressora estï¿½ conectada."
    End If
End Sub
...
Private Function ArquivoExiste() As String
    ...
    Else
        MsgBox "0 arquivo do comprovante C:\Cliente\Resp\INTPOS.001 nï¿½o existe!"
        ArquivoExiste = ""
    End If
End Function
