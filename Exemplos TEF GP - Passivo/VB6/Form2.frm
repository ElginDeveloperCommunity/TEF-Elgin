...
Public Sub btnConectar_Click()
    ...
    If Form1.TestaConexao <> "" Then
        MsgBox "Sua impressora est� conectada"
    Else
        MsgBox "Houve algum problema na hora da conex�o, verifique os parametros" + vbCrLf + vbCrLf + CStr(tipo) + vbCrLf + modelo + vbCrLf + conexao + vbCrLf + CStr(parametros)
    End If
End Sub
