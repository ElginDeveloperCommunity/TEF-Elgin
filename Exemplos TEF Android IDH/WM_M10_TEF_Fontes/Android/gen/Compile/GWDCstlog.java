...
public class GWDCstlog extends WDStructure
{
public WDObjet mWD_tag = new WDChaineA();
public WDObjet mWD_valor = new WDChaineA();
public WDObjet mWD_numvdax = new WDChaineA();
...
{
if(sNomMembre.equals("tag")) return mWD_tag;
if(sNomMembre.equals("valor")) return mWD_valor;
if(sNomMembre.equals("numvdax")) return mWD_numvdax;
...
switch(nIndice)
{
case 0 : membre.m_refMembre = mWD_tag; membre.m_strNomMembre = "mWD_tag"; membre.m_bStatique = false; membre.m_strNomMembreWL = "tag"; membre.m_bSerialisable = true; membre.m_strNomSerialisation = null; membre.m_strMapping = null; membre.m_nOptCopie = 0; membre.m_nOptCopieEltTableau = 0; membre.m_bAssocie = false; membre.m_bCleUnique = false; return true;
case 1 : membre.m_refMembre = mWD_valor; membre.m_strNomMembre = "mWD_valor"; membre.m_bStatique = false; membre.m_strNomMembreWL = "valor"; membre.m_bSerialisable = true; membre.m_strNomSerialisation = null; membre.m_strMapping = null; membre.m_nOptCopie = 0; membre.m_nOptCopieEltTableau = 0; membre.m_bAssocie = false; membre.m_bCleUnique = false; return true;
case 2 : membre.m_refMembre = mWD_numvdax; membre.m_strNomMembre = "mWD_numvdax"; membre.m_bStatique = false; membre.m_strNomMembreWL = "numvdax"; membre.m_bSerialisable = true; membre.m_strNomSerialisation = null; membre.m_strMapping = null; membre.m_nOptCopie = 0; membre.m_nOptCopieEltTableau = 0; membre.m_bAssocie = false; membre.m_bCleUnique = false; return true;
