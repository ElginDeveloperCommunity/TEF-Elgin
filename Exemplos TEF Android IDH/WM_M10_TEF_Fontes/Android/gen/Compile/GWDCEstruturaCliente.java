 ...
 * Android class: EstruturaCliente
...
public class GWDCEstruturaCliente extends WDStructure
{
public WDObjet mWD_qtd = new WDEntier4();
public WDObjet mWD_registros = new WDTableauSimple(1, new int[]{0}, 0, new IWDAllocateur(){public WDObjet creerInstance(){return new GWDCstCliente();}	public int getTypeWL() {return 36;}		public boolean isDynamique(){return false;}	public Class getClasseWD(){return GWDCstCliente.class;}		}, 0);

public GWDCEstruturaCliente()
{
}
