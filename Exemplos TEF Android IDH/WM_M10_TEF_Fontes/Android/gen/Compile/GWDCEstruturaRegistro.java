 ...
 * Android class: EstruturaRegistro
...
public class GWDCEstruturaRegistro extends WDStructure
{
public WDObjet mWD_qtd = new WDEntier4();
public WDObjet mWD_registros = new WDTableauSimple(1, new int[]{0}, 0, new IWDAllocateur(){public WDObjet creerInstance(){return new GWDCstRegistro();}	public int getTypeWL() {return 36;}		public boolean isDynamique(){return false;}	public Class getClasseWD(){return GWDCstRegistro.class;}		}, 0);

public GWDCEstruturaRegistro()
{
}
